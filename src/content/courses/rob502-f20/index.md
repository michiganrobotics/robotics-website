...
- There are variety of C concepts that will not be explicitly covered in class! We are providing a [C review notes tutorial (PDF)](c_review_notes.pdf) to help explain the necessary syntax and basic ideas so we can delve right into the good stuff!
