...
description: "Resources and contacts for reporting concerns, misconduct, and prohibited behavior within Michigan Robotics."
date: "2025-09-03"
---

Whenever possible, we encourage you to resolve concerns directly or at the lowest level appropriate. This could be addressing the issue with the individuals involved, if you feel safe and comfortable doing so. If that isn't possible or doesn't resolve the concern, you can escalate by reaching out to your supervisor, or if that is not possible, Robotics HR, the Unit Administrator (UA), or the Chair, depending on the situation.
...
* [Mark Kushner](https://facultyombuds.umich.edu/unit-ombuds/), College of Engineering Faculty Ombuds  
