...
- For example, if you have three courses you'd like to double-count and each is worth 4 credits (totalling 12 credits), you may only double-count 9 of those 12 credits. This means, you would double-count 3 credits from each course, and the remaining 1 credit from each course would not be applied to your Master's degree. The same logic applies to transferring credits: from a 4-credit course, you can transfer only 3 credits.
