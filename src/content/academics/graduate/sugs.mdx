...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
  <div class="surface p-6 rounded-lg">
    ...
    <div class="space-y-3">
      ...
      <div>
        ...
        <p class="text-sm"><a href="https://myadvising.lsa.umich.edu/appointments/offices/ROB" class="text-umichblue dark:text-maize hover:underline">Schedule an appointment</a> or email <a href="mailto:robotics-sso@umich.edu" class="text-umichblue dark:text-maize hover:underline">robotics-sso@umich.edu</a></p>
      </div>
  ...
  <div class="surface p-6 rounded-lg">
    ...
    <div class="space-y-3">
      ...
      <div>
        <p class="italic">You can:</p>
        <p class="text-sm"><a href="https://calendar.app.google/uFV6eMYYFYdC6tA8A" class="text-umichblue dark:text-maize hover:underline">Schedule an appointment</a> or email <a href="mailto:robotics-sso@umich.edu" class="text-umichblue dark:text-maize hover:underline">robotics-sso@umich.edu</a></p>
      </div>
