...
description: "Requirements and proposal process for ROB 590 directed study and ROB 690 independent research projects in Michigan Robotics."
date: "2022-05-12"
---
...
<Callout type="info">
**Looking for current projects?** View [current ROB 590/690 projects](/academics/courses/course-offerings/current-590-690/) *(U-M login required)*.
</Callout>
...
<Callout type="maize">
**Important:** Do not register for ROB 590 until you have received approval from the faculty member who will serve as your research advisor. Students must obtain verbal or written approval from the supervising professor before enrolling in ROB 590. The ROB 590 Proposal Form may be submitted after that approval, but students should not register for ROB 590 without first confirming that a faculty member has agreed to supervise the research.
</Callout>
...
The research advisor should email their approval for the student to register for ROB 690 to robotics-sso@umich.edu. After receiving this approval, the Student Services Office (SSO) will email the student with permission to enroll in the course.
