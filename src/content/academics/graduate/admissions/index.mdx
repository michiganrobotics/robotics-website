...
import PhDDefense from "../../images/phd-defense-atrium.jpg";

<p class="mt-0 text-xl max-w-5xl leading-relaxed">Welcome and thank you for your interest in applying. While reviewing applications, we always consider the applicant as a whole, giving time to thoughtfully consider each portion of the application.</p>
...
<div class="surface-secondary !bg-umichblue rounded-lg p-6 mb-8">

To begin completing an application:

<MaizeButton href="https://rackham.umich.edu/admissions/applying/" class="!text-umichblue" text="Apply through Rackham" external="true" />
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-2">
  <div class="space-y-2">
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/graduate-application/">Graduate Application & Fee</a>
    </div>
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/letters-of-recommendation/">Letters of Recommendation</a>
    </div>
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/transcripts/">Transcripts</a>
    </div>
  </div>
  <div class="space-y-2">
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/academic-and-personal-statements/">Academic & Personal Statements</a>
    </div>
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/resume-curriculum-vitae/">Resume/Curriculum Vitae</a>
    </div>
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/english-proficiency-test-scores/">English Proficiency Test Scores</a>
    </div>
  </div>
</div>
...
<Accordion title="GRE reporting details">
...
* GRE scores of up to 5 years old as of the application deadline may be used. The committee will see all test scores *submitted* to the University of Michigan.  
...
* If you decide to take it, then take the GRE revised General Test.  
...
| :---- | :---- |
| PhD | Anytime between December and April. Majority of offers will be made between February and March. |
| Master’s | Mid-March. |
| SUGS | Mid-March. |
...
<div class="columns-1 lg:columns-2 gap-6">
  ...
  <div class="surface rounded-lg p-6 mb-6 lg:mb-0 break-inside-avoid-column">
    <h4>Change of program</h4>
    <p>If you are a current Rackham graduate student at the University of Michigan, you may [apply to change from one graduate program to another](https://robotics.umich.edu/academics/graduate/admissions/change-of-program/) within the Graduate School.</p>
  </div>
  <div class="surface rounded-lg p-6 mb-6 break-inside-avoid-column">
    <h4>Dual degree</h4>
    <p>If you are a current, non-Robotics graduate student at the University of Michigan. you may [**add** (not switch to) a Robotics Master’s degree as a dual degree.](https://robotics.umich.edu/academics/graduate/admissions/dual-degree/)</p>
  </div>
</div>
...
<div class="columns-1 lg:columns-2 gap-6">
  <div class="mb-6 break-inside-avoid-column last:mb-0">
  ...
  <div class="surface rounded-lg p-6 mb-6 break-inside-avoid-column last:mb-0">
    <h3 class="mt-0">Admissions statistics</h3>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
  <div class="lg:col-span-2 surface rounded-lg p-6 mb-6">
    <h3>Tuition</h3>
...
<div class="grid md:grid-cols-3 gap-4 mt-6 mb-8">
  <div class="surface rounded-lg p-4 border border-arboretumBlue border-2 dark:border dark:border-arboretumBlue/40">
    <h3 class="text-xl! font-semibold mb-2">Begin your application</h3>
    <p class="text-sm mb-3">Start your graduate application through Rackham.</p>
    <MaizeButton href="https://rackham.umich.edu/admissions/applying/" text="Apply now" external="true" class="!w-full mt-auto" />
  </div>
  
  <div class="surface-accent rounded-lg p-4">
    <h3 class="text-xl! font-semibold mb-2">Change of Program or Dual Degree</h3>
    <p class="text-sm mb-3">Already a Rackham student?</p>
    <p class="text-sm">Apply to <a href="/academics/graduate/admissions/change-of-program/">change programs</a> or <a href="/academics/graduate/admissions/dual-degree/">add a dual degree in robotics</a>.</p>
  </div>
  
  <div class="surface dark:!bg-rackhamGreen-dark rounded-lg p-6 border border-rackhamGreen border-2">
    <h3 class="text-xl! font-semibold mb-2">SUGS Program</h3>
    <p class="text-sm mb-3">Current U-M undergraduates interested in a Robotics graduate degree?</p> 
    <p class="text-sm"><a href="/academics/graduate/sugs/">Learn more about SUGS</a>.</p>
  </div>
</div>
...
Additional information on criteria for admissions and degree programs is available on the [Rackham Admissions site](https://www.rackham.umich.edu/prospective-students).
</div>
...
<Image 
  src={PhDDefense} 
  alt="A PhD candidate defends their dissertation in the atrium of the Ford Robotics Building"
  class="w-full rounded-sm"
/>
<figcaption>A PhD candidate defends their dissertation in the atrium of the Ford Robotics Building.</figcaption>
</figure>
</div>
</div>
</TextWithImage>