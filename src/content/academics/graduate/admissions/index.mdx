...
<div class="columns-1 lg:columns-2 gap-6">
  ...
  <div class="surface rounded-lg p-6 mb-6 break-inside-avoid-column">
    <h4>Dual degree</h4>
    <p>If you are a current, non-Robotics graduate student at the University of Michigan. you may [**add** (not switch to) a Robotics Master’s degree as a dual degree.](https://robotics.umich.edu/academics/graduate/admissions/add-a-degreedual-degree-instructions/)</p>
  </div>
</div>
