...
<div class="grid md:grid-cols-3 gap-4 mt-6 mb-8">
  <div class="surface rounded-lg p-4 border border-arboretumBlue border-2 dark:border dark:border-arboretumBlue/40">
    <h4 class="font-semibold mb-2">Begin your application</h4>
  ...
  <div class="surface-accent rounded-lg p-4">
    <h4 class="font-semibold mb-2">Change of Program or Dual Degree</h4>
  ...
  <div class="surface dark:!bg-rackhamGreen rounded-lg p-6 border border-rackhamGreen border-2">
    <h4 class="font-semibold mb-2">SUGS Program</h4>
