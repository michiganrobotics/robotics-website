...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-2">
  <div class="space-y-2">
    <div class="flex items-center">
      ...
      <a href="/academics/graduate/admissions/graduate-application/" class="text-umichblue hover:text-maize">Graduate Application & Fee</a>
    </div>
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/letters-of-recommendation/" class="text-umichblue hover:text-maize">Letters of Recommendation</a>
    </div>
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/transcripts/" class="text-umichblue hover:text-maize">Transcripts</a>
    </div>
  </div>
  <div class="space-y-2">
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/academic-and-personal-statements/" class="text-umichblue hover:text-maize">Academic & Personal Statements</a>
    </div>
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/resume-curriculum-vitae/" class="text-umichblue hover:text-maize">Resume/Curriculum Vitae</a>
    </div>
    <div class="flex items-center">
      <span class="w-2 h-2 bg-maize rounded-full mr-3 flex-shrink-0"></span>
      <a href="/academics/graduate/admissions/english-proficiency-test-scores/" class="text-umichblue hover:text-maize">English Proficiency Test Scores</a>
    </div>
  </div>
</div>
