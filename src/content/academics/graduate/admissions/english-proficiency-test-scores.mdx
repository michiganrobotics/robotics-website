...
<Accordion title="Who should submit English test scores?">
...
<Accordion title="What is the minimum test score requirement for TOEFL, MELAB and IELTS?">
TOEFL Internet (IBT) scores: 84, TOEFL Paper (PBT) scores: 560, MELAB scores: 80 and IELTS scores: 6.5.
</Accordion>

<Accordion title="I applied in a previous year and my scores are still valid. Do I have to have ETS resubmit my scores?">
You do not need to resubmit your scores if they're still valid.
</Accordion>

<Accordion title="How can I waive the requirement to submit English test scores if English is not my native language?">
...
<Accordion title="How long are the TOEFL, MELAB OR IELTS scores valid?">
English test scores are valid for two years from the test date.
</Accordion>

<Accordion title="When should I submit the test scores?">
TOEFL, MELAB OR IELTS scores must be submitted _**on or before**_ the application deadline.
</Accordion>

<Accordion title="How are TOEFL, MELAB OR IELTS scores sent to the University of Michigan?">
...
<Accordion title="What should I do if my English test scores are below the minimum requirement?">
...
<Accordion title="My TOEFL, MELAB OR IELTS scores are close to expiring. Should I retake the test?">
...
<Accordion title="I took multiple English tests. Will the Graduate Admission Committee see all of my scores?">
Yes, the committee will see all test scores submitted to the University of Michigan.
</Accordion>

<Accordion title="I submitted my English test scores to the University of Michigan. Should I also submit the test score report from ETS?">
