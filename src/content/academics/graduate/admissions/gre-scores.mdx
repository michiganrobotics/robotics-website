...
<Accordion title="Is the GRE test required for all applicants?">
...
<Accordion title="Is there a penalty for not submitting GRE scores, or a bonus if submitting them?">
...
<Accordion title="How long are GRE scores valid?">
GRE scores are valid for five years from the test date.
</Accordion>

<Accordion title="My GRE scores are close to expiring. Should I retake the test?">
...
<Accordion title="Which GRE test should I take?">
If you decide to take it, the GRE revised General Test.
</Accordion>

<Accordion title="What is the minimum score for the GRE?">
...
<Accordion title="How are GRE scores sent to the University of Michigan?">
...
<Accordion title="I took multiple GRE tests. Will the Graduate Admission Committee see all of my scores?">
