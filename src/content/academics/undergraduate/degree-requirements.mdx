...
<div class="columns-1 lg:columns-2 gap-6">
  ...
  <div class="surface rounded-lg p-6 mb-6 break-inside-avoid-column">
    ...
    <ul>
      ...
      <li>Visit the [Sample Schedules](#robotics-sample-schedules) to view different pathways through the degree and how choosing certain combinations of these courses could take you down a pathway of interest.</li>
    </ul>
  </div>
