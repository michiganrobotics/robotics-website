...
Concentrations are optional specializations of 12 or more credits that let you go deeper in an area such as Perception and Reasoning, Dynamics and Control, or Human-Robot Interaction. You can declare a concentration anytime before applying for graduation by meeting with an advisor. See the [degree requirements page](/academics/undergraduate/degree-requirements/#concentrations) for the full list and policies.
</div>
