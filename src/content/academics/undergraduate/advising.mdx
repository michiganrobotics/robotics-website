...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
 ...
 <div class="col-span-1 md:col-span-2 lg:col-span-3 surface rounded-lg p-4 border border-maize/60 hover:border-maize transition-all duration-200">
   ### Robotics Undergraduate Student Council
    <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">The Robotics Undergraduate Student Council (RUSC) is the student-run organization that holds outreach, social, educational, and professional events. RUSC works closely with the Robotics Department on many orders of operation including providing input on curriculum and feedback to department leadership. Any Robotics undergraduate student can join.</p>
