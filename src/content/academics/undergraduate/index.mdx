...
<div class="border-rackhamGreen border-2 dark:border-none p-6 rounded-lg mb-8 dark:bg-tappanRed">
...
<TwoColumn>
  <div slot="left">
    ...
    <div class="bg-gray-50 border-maize border dark:border-none dark:bg-arboretumBlue p-6 rounded-lg mb-4">
  ...
  <div slot="right">
    <div class="bg-gray-50 border-maize border dark:border-none dark:bg-arboretumBlue p-6 rounded-lg">
...
<div class="bg-gray-50 border-matthaeiViolet border-2 dark:border-none dark:bg-arboretumBlue p-6 rounded-lg mt-8">
