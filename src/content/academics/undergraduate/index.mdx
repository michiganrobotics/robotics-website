...
<TwoColumn>
  ...
  <div slot="right">
    <div class="bg-lawQuadStone text-white p-6 rounded-lg mb-4">
      ...
      <MaizeButton href="https://arxiv.org/abs/2308.06905v1" text="Read Whitepaper" />
    </div>
  </div>
</TwoColumn>
...
<TwoColumn>
  <div slot="left">
    ...
    <div class="bg-gray-50 dark:bg-arboretumBlue p-6 rounded-lg mb-4">
      ...
      <MaizeButton href="http://piazza.com/umich/winter2022/roboticsugqa" text="Join the Piazza" />
    </div>
  </div>
  ...
  <div slot="right">
    <div class="bg-gray-50 dark:bg-arboretumBlue p-6 rounded-lg">
      ...
      <MaizeButton href="https://events.umich.edu/group/3998" text="View events" />
    </div>
  </div>
</TwoColumn>
...
<div class="space-y-4">
  ...
  <Accordion title="What are introductory Robotics classes like?">
    ...
    <ul class="list-disc pl-6 space-y-2">
      <li><a href="//robotics.umich.edu/academic-program/course-offerings/rob101-fall-2020/" class="hover:underline">ROB 101: Computational Linear Algebra</a></li>
      <li><a href="//robotics.umich.edu/academic-program/course-offerings/rob-102-intro-to-ai-programming/" class="hover:underline">ROB 102: Introduction to AI and Programming</a></li>
      <li><a href="//robotics.umich.edu/2021/building-the-basics-in-rob-103-robotic-systems/" class="hover:underline">ROB 103: Robotic Mechanisms</a></li>
      <li><a href="//robotics.umich.edu/academic-program/course-offerings/rob-204-winter-2022/" class="hover:underline">ROB 204: Introduction to Human-Robot Systems</a></li>
    </ul>
  </Accordion>
