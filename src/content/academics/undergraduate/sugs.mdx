...
If a student has multiple courses that add up to more than 9 credits, part of a course may be double-counted so as not to exceed the 9 credit double-counting maximum. Courses must be transferred in their entirety.
</Accordion>
