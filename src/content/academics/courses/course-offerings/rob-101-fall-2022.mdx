---
title: "ROB 101: Computational Linear Algebra - Fall 2022"
description: "Course information for ROB 101: Computational Linear Algebra, Fall 2022, a first-year undergraduate course at Michigan Robotics."
date: "2022-03-25"
---

## Fall 2022

![A 3D model of a robot in a lidar field with linear algebra equations floating above it](../../images/fall-2021-1024x512.jpg)
...
Read more about the course development in [ASEE Prism: Solving for Equity](https://www.asee-prism.org/solving-for-equity/).
...
<Accordion title="Can I be enrolled in ROB 101 and another course that overlaps in the time schedule with ROB 101?">
Yes. You check to check a box on Wolverine Access to allow you to do that. You can then enroll in the remote section of ROB 101.
</Accordion>

<Accordion title="Can I be in the remote section for the lecture and the in-person section for the lab?">
No. Wolverine Access does not offer that flexibility. The in-person section of the labs will be relatively lightly attended. It will be easy to drop into them in person. Hence, choose your modality based on the lecture.
</Accordion>

<Accordion title="Do I have to complete the labs?">
No. Labs are not graded. They are designed to make the HW easier. HW is graded. Everything in ROB 101 is done to assist your learning of the material.
</Accordion>
...
We expect to admit 100 students. Preference will be given to Y1 students (freshmen). We are currently looking into options to significantly expand the online section of the course–provided we can hire adequate teaching support for expanded enrollment.

We recommend joining the waitlist for the online section, as we are more likely to be able to expand this section. You can [sign up for the course waitlist using these instructions](https://docs.google.com/document/d/1dTq0Y8pZ8rFTld7UW8yZ0pDUQCPGFx6eg79tS12EkKU/edit?usp=sharing "sign up for the course waitlist using these instructions").
</Accordion>
