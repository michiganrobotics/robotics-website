...
This is a relatively new area of robotics. Traditionally, roboticists determined what they wanted their machines to do, and then computed the lowest-energy way to do it. The presence of people in the robot environment hadn’t entered the equation in a major way. Nevertheless, people have their own goals, interests, and levels of safety and comfort when encountering robots that the latter need to account for.
