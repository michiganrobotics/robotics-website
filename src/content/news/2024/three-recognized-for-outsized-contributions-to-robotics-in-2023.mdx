...
date: 2024-02-06
seoDescription: Robotics honors staff and faculty who create a welcoming
  community, exemplify our values, and allow our roboticists to prosper.
excerpt: Robotics honors staff and faculty who create a welcoming community,
  exemplify our values, and allow our roboticists to prosper. We recognize Chad
  Jenkins, Abhishek Narula, and Samantha Price for doing so.
image:
  src: images/2023-06-26-11.47.29-1024x683.jpg
  alt: Abhishek Narula and Peter Gaskell sort through a table of Mbot PICO+ chips
    in the ROB 550 lab.
categories:
  - robotics-community
tags:
...
<figure>
  ...
  <figcaption>Abhishek Narula and Peter Gaskell check through an order of Mbot PICO+ chips in the summer before assembling the fall fleet of robots.</figcaption>
</figure>
...
This year’s Robotics recipients of the Staff Incentive Program are [Abhishek Narula](https://robotics.umich.edu/people/staff/abhishek-narula/) and [Samantha Price](https://robotics.umich.edu/profile/samantha-price/ "Samantha Price").
...
This year's Robotics Department Faculty Award honors [Chad Jenkins](https://robotics.umich.edu/profile/chad-jenkins/ "Chad Jenkins").
...
Abhishek Narula, Full Stack Engineer, develops and builds technologies to help courses and labs teach robotics concepts to students. Narula has been a key member of the [Mbot](http://mbot.robotics.umich.edu) team, which is the mobile, educational robot platform underlying a significant number of robotics classes. Narula helps manage the over 300 Mbots in the department fleet, and works tightly with instructors and students to meet the growing needs of the department.
