...
<figcaption>The roofing octocopter, equipped with a nail gun, is parked near the mock roof. By setting the wooden panel at different inclines, the researchers simulated roofs with different slopes. Image credit: Matthew Romano, Michigan Robotics.</figcaption>
</figure>

An octocopter capable of attaching asphalt shingles to roofs with a nail gun has been demonstrated at the University of Michigan's [M-Air](https://robotics.umich.edu/about/facilities/m-air-net/), an outdoor autonomous system testing lab.
