...
date: "2018-12-17"
seoDescription: "A future air traffic control system that allows any number of autonomous planes to safely route around each other to their final destinations."
excerpt: "Anticipating skies crowded with crisscrossing autonomous vehicles, University of Michigan researchers have developed a future air traffic control system that allows any number of autonomous planes to safely route around each other to their final destinations."
image:
...
<figcaption>In this simulation, autonomous fixed-wing aircraft change goal points and flight modes to avoid collisions based on control laws developed by Kunal Garg.</figcaption>
</figure>
