...
categories: 
  - "robotics-community"
image: 
  src: "../content/news/2022/images/DSC02584-scaled.jpg"
...
![Student works on robot in ROB 103](images/DSC02584-1024x606.jpg)

<figcaption>

A student in [ROB 103: Robotic Mechanisms](https://www.youtube.com/watch?v=95xv9ae5rcE), works on programming a robot the team designed from scratch.
...
The outreach to historically excluded populations is reflective of the department's [commitment to diversity, equity and inclusion](https://2024.robotics.umich.edu/about/values/) and the college's [equity-centered engineering framework](https://www.engin.umich.edu/2021/06/equity-centered-engineering-a-qa-with-alec-gallimore/).
