...
In addition to supporting the CSE chair and David Chesney, lecturer in CSE, Orenstein’s gift will help fund the Robotics Institute’s efforts to accelerate the capabilities of smart machines, such as powered prosthetics, and to enable access to all in studying, creating, and utilizing robotics. This support will directly apply to the Managing Director of the Robotics Institute, [Damen Provost](https://robotics.umich.edu/profile/damen-provost/ "Damen Provost").
