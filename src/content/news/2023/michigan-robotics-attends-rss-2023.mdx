...
Michigan roboticists, many representing the [new University of Michigan Robotics Department](https://robotics.umich.edu/2021/first-robotics-department/ "The first robotics department among top 10 engineering schools"), will be presenting a total of nine papers at [Robotics Science and Systems](https://roboticsconference.org) (RSS). Their research covers a wide range of topics from robot teams and trust propagation to trajectory design and motion planning. The RSS conference is held in Daegu, Korea, from July 11 to July 14.
